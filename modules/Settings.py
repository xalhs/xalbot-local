HOST = "irc.twitch.tv"
PORT = 6667
PASS = ""   #Oauth token of your bot account, get it from here  https://twitchapps.com/tmi/
IDENT = ""  #twitch name of your bot account
CHANNEL = ""  #channel you want your bot to run on
CLIENT_ID = ""      # you can get one if you register an application to https://dev.twitch.tv/docs/v5   # same as above, by registering an application to https://dev.twitch.tv/docs/v5
